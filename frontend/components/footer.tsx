    ...
    <nav className="flex flex-col items-center justify-center px-6 py-12 md:py-20 bg-white border-t border-[#D3D3D3] text-white w-full mt-251 gap-">
      <div className="flex flex-row items-center justify-center gap-4">
        <a href="https://github.com/EvanDevelopments">
          <button className="cursor-pointer hover:bg-slate-200 hover:text-black text-[#2063f5] px-4 py-2 rounded-lg font-medium transition-all rounded inline-flex items-center">
        ...
        <div className="text-[#2063f5] text-sm text-center w-full mt-4">
