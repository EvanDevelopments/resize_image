...
export default function Home() {
  ...
  return (
      ...
      <main className="">
          <div className="flex flex-row items-center justify-center pt-120  px-10 gap-20 text-[#2063f5]">
          ...
          <div className="py-20 text-white flex flex-col items-center gap-5">
            <button onClick={() => fileInputRef.current.click()} className="bg-white hover:bg-slate-200 text-[#2063f5] font-bold py-2 px-4 rounded inline-flex items-center cursor-pointer">
